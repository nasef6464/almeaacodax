...
import { buildInternalLearningPath } from "./learningPathService";
...
/** @deprecated SmartLearningPath is internal-first. Kept only for compatibility callers. */
export const generateLearningPath = async (skills: SkillGap[]): Promise<LearningRecommendation[]> =>
  buildInternalLearningPath(skills, []);
