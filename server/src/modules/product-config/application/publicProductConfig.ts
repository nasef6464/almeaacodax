...
} from "../../content/http/platformPresentationSchemas.js";
import { platformIntegrationSettingsSchema } from "../../content/http/platformIntegrationSchemas.js";
import {
  defaultHomepageSettings,
  defaultPlatformFontSettings,
} from "../../content/presentation/platformPresentationDefaults.js";
import { defaultPlatformIntegrationSettings } from "../../content/integrations/platformIntegrationDefaults.js";
...
export const publicProductConfigSchema = z.object({
  version: z.literal(1),
...
export type PublicProductConfig = z.infer<typeof publicProductConfigSchema>;
