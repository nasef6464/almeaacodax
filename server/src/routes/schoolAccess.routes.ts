...
const directorAssessmentSchema = z.object({ title: z.string().trim().min(3).max(180), classId: z.string().min(1), subjectId: z.string().trim().max(120).optional().default(""), questionIds: z.array(z.string().min(1)).min(1).max(100) });
