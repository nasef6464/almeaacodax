...
const courseSchema = new Schema(
  {
    ...
    fakeStudentsCount: { type: Number, default: 0 },
    fakeRating: { type: Number, default: 5 },
    prerequisiteCourseIds: { type: [String], default: [] },
    dripContentEnabled: { type: Boolean, default: false },
    certificateEnabled: { type: Boolean, default: false },
    lessonStartIcon: { type: String, default: "" },
    lessonStartIconColor: { type: String, default: "" },
    lessonEndIcon: { type: String, default: "" },
    lessonEndIconColor: { type: String, default: "" },
