...
// Keep this non-unique until a production-safe migration verifies/backfills legacy
// duplicate attempt numbers. submissionKey remains the retry/idempotency guard.
