...
CLASS_CARD_SMOKE = ROOT / "scripts/smoke-schools-class-card-boundary-contract.mjs"
...
class_card_smoke = """import { readFileSync } from 'node:fs';
...
"""
CLASS_CARD_SMOKE.write_text(class_card_smoke, encoding="utf-8")
