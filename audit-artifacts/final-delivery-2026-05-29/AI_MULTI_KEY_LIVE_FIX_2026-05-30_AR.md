...
- تمت إضافة عرض مباشر لوضع تشغيل المساعد داخل لوحة التكاملات ومساعد المدير:
  - يدوي: يستخدم المزود المختار أولا.
  - تلقائي: ينتقل عند تعطل المفتاح أو المزود.
- تم ربط هذا العرض بقيمة `routingMode` القادمة من `/ai/status` حتى لا تكون الواجهة مجرد حقول محفوظة.
