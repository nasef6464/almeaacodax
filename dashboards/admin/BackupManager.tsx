                ...
                <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                    <div>
                        ...
                        <p className="mt-1 max-w-3xl text-sm font-bold leading-7 text-amber-900">
                            الجدولة التلقائية غير مفعّلة على بيئة الإنتاج الحالية. النسخ اليدوية المتاحة هنا لا تُعد بديلاً عن Full MongoDB + R2 DR Backup.
                        </p>
                        <p className="mt-2 text-xs font-bold leading-6 text-amber-800">
                            يلزم ربط Cron/Backup service حقيقي، ونسخة خارج نفس بيئة التشغيل، ثم نجاح Restore Drill قبل تفعيل أي جدول من هنا.
                        </p>
                    </div>
