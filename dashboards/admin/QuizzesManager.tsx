...
export const QuizzesManager: React.FC<QuizzesManagerProps> = ({ subjectId, filterType }) => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {openedFromSupervisorDashboard && (
        <div data-testid="supervisor-directed-quiz-context" className="rounded-2xl border border-violet-100 bg-violet-50/70 p-4">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <h3 className="text-sm font-black text-violet-900">اختبار موجه مركزي من لوحة المشرف</h3>
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <button data-testid={`assessment-manager-edit-${quiz.id}`} onClick={() => handleEdit(quiz.id)} className="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors" title="تعديل">
                          <Edit2 size={18} />
                        </button>
