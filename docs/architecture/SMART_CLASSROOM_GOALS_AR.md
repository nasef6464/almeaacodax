...
| `G6` | `BLOCKED` | `c468a6a7c1487e9ba411d99ba9db99b2fdb205e5` (preflight only) | Backend CI [34415332078](https://github.com/nasef6464/almeaacodax/actions/runs/34415332078) PASS; fail-closed runner, scenario template, and negative cross-school join check ready, but no authorized Pilot was run. Production health on 2026-09-10 reported `b131d8eb405e`, which is not a descendant of the G1–G6 runtime. | دمج/نشر runtime الموثق بموافقة المالك، ثم تحديد البيئة والمدرسة/الفصول والمعلمين والبيانات المسموحة وبدء Pilot فقط |
