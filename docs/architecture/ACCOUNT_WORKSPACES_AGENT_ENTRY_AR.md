...
- Account Workspaces `G7` إلى `G12` مغلقة؛ G12 مثبت على runtime `fb5790067` وCI `34465893298`.
- لا يوجد هدف تنفيذ نشط في هذا المسار. تقرير الحكم التجاري في
  `ACCOUNT_WORKSPACES_COMMERCIAL_CLOSURE_AR.md`.
...
توقف بعد كل Goal لإغلاق branch/PR وتحديث الدليل. تفويض `G7–G12` استُنفد
بالإغلاق؛ أي تطوير لاحق يحتاج هدفًا مستقلًا ولا يعيد فتح العمل المثبت بلا عيب واضح.
