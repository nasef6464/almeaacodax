...
- Account Workspaces `G7` و`G8` و`G9` مغلقة؛ G9 مثبت على runtime `68768d00` وCI `34456463696`.
- الهدف الحالي المفوض هو `G10 — Usable School Director Dashboard`، ثم يستمر التفويض حتى `G12` بالتسلسل.
