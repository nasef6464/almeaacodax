...
| Quiz/Assessment definitions | آلاف | builder/access/assignment | versioning additive، لا نسخ غير ضرورية | PARTIAL |
| Attempts/Responses/Results | ملايين | student result/report/submit | فصل response عن summary عند القياس، idempotency | NOT PROVEN |
