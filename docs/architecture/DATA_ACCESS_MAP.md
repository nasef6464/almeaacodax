...
| Users/Groups/Memberships | آلاف/مئات المدارس | scope/roster/report | pagination؛ تقييم arrays الكبيرة؛ Teacher لا يملك Group CRUD ضمن School Operations؛ Admin relations import assigns Teacher via schoolId/groupIds without supervisorIds | PARTIAL |
