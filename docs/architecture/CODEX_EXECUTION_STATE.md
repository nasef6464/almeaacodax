...
- Current batch: `6A-07` — selected-school class rename action extraction and isolated end-to-end verification
- Current branch: `codex/assessment-data-evolution`
- Current implementation HEAD (before this state-record commit): `3ffc7118d501b0ef0fb34a5cc815b0abf376bbe6` (`refactor(schools): isolate class rename action`)
