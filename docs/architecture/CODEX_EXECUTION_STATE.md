...
- Current frontend delivery: Student assessment navigation and Mock Hub organized into 3 dedicated sidebar items (الاختبارات السابقة, الاختبارات المدرسية, ⭐ الاختبارات المحاكية) with Mock Hub partitioned into available catalog models and student past attempts; SchoolTestsPanel and Attempt cards polished. Verified on exact commit `b99739c2`. All smoke contracts (10/10 quizzes, 13/13 student journey) and production build pass.
