...
- Current frontend delivery: Student assessment navigation and Mock Hub organized into 3 dedicated sidebar items (الاختبارات السابقة, الاختبارات المدرسية, ⭐ الاختبارات المحاكية) with Mock Hub partitioned into available catalog models and student past attempts using unified AttemptGroupCard matching Quizzes attempt presentation. Verified on exact commit `b7d2a2fb`. All smoke contracts (10/10 quizzes, 13/13 student journey) and production build pass.
