...
- Next exact action: map quiz publication decision/policy into the next compatible application boundary without touching scoring, persistence, or authorization semantics
