...
- Current batch: assessment legacy-builder runtime inventory completed
- Current branch: `refactor/modular-platform-safe`
- Last completed commit: `645cff42` (legacy-builder inventory guard); question-bank source pagination is `f2835634`
...
- Next exact action: design focused API integration coverage for create/publish/access/submit across admin, supervisor, teacher, and student roles. Do not delete a builder or change routes/schema/RBAC/scoring.
