...
- Current batch: supervisor school/class scope separation across schools and assessment reports
- Current branch: `refactor/modular-platform-safe`
- Last completed code commit: `79ce8b80` (keep class supervisor scope narrow in reports); isolated assessment CI gate is `a6ad996c`
