...
- G6 preflight: `SMART_CLASSROOM_G6_PILOT_RUNBOOK_AR.md` يحدد قرار البيئة والبيانات، سيناريو الفصلين/المعلمين، وقياسات latency/reconnect/write integrity وحدود التقرير؛ لا يوجد تشغيل Pilot أو كتابة بيانات خارجية حتى الآن.
