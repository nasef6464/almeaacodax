...
- G6 preflight: exact runtime `a2aa9b3fd600dc75860cbe26fe4fbef6e971c80a` passed Backend Integration [34415018436](https://github.com/nasef6464/almeaacodax/actions/runs/34415018436). `SMART_CLASSROOM_G6_PILOT_RUNBOOK_AR.md` وrunner fail-closed يحددان قرار البيئة والبيانات، سيناريو الفصلين/المعلمين، وقياسات latency/reconnect/write integrity وحدود التقرير؛ لا يوجد تشغيل Pilot أو كتابة بيانات خارجية حتى الآن.
