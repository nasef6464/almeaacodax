...
- Current implementation HEAD: `038255fb` (`ci: prevent isolated deep audit rate limiting`)
- Branch relation: runtime HEAD is pushed and verified by Backend Integration `33683096158` and Deep Pre-Merge E2E `33683096173`. Existing generated audit modifications and ZIP/text files are excluded from this batch.
