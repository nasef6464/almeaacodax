...
- Current implementation HEAD: `47dabd68` (`fix(assessment): expose mock section results to learners`)
...
- Next exact action: inspect ACC-04 public result/history/analytics entry points and implement only its first unproven user-facing gap. Do not reconstruct attempts/responses/definitions, opt in production assessments, change scoring/RBAC/API contracts, or delete legacy records.
