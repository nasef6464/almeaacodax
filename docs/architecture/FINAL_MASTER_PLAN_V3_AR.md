...
خطة التنفيذ الرئيسية وتسلسل الأهداف وحدود الـMVP موجودة في `CHAT_EXECUTION_GOALS_AR.md`. هذه الوثيقة تبقى مرجع الرؤية والمعمار والبوابات، و`CODEX_EXECUTION_STATE.md` يسجل التنفيذ الفعلي.
