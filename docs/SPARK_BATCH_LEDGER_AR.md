...
| 17 | Auth Cookie Migration Phase 1 | Programmatically closed, final manual browser verification pending | 2026-05-17 | BATCH_17R_AUTH_COOKIE_PRODUCTION_CLOSURE_2026-05-17_AR.md | تم النشر على الإنتاج (`0d25f1ee1897`) وتحقق حي PASS لمسارات callback بدون oauth_token؛ متبقٍ تحقق يدوي أخير داخل المتصفح لتنظيف الجلسات القديمة. |
| 18 | SEO BrowserRouter Migration Plan | Fully closed | 2026-05-17 | SEO_BROWSERROUTER_MIGRATION_PLAN_2026-05-14_AR.md | ???? ??? ?????. |
| 19 | SEO BrowserRouter Safe Implementation | Programmatically closed, production verification pending | 2026-05-17 | SEO_BROWSERROUTER_SAFE_IMPLEMENTATION_2026-05-14_AR.md | ??????? ????? ??????? ????? ????? ?????? ???????? ???????. |
