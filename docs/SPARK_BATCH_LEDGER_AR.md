...
| 17 | Auth Cookie Migration Phase 1 | Programmatically closed, production verification pending | 2026-05-17 | BATCH_17R_AUTH_COOKIE_PRODUCTION_CLOSURE_2026-05-17_AR.md | تم إيقاف تخزين token في localStorage وتحويل التدفق cookie-first وإزالة oauth_token من callback URL؛ بانتظار تحقق حي بعد النشر. |
