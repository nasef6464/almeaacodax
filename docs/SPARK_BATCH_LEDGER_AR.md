...
| 17 | Auth Cookie Migration Phase 1 | Programmatically closed, security hardening pending | 2026-05-17 | AUTH_COOKIE_MIGRATION_PHASE1_2026-05-14_AR.md | ?? ???? ????? ?????? ?? localStorage ???????? oauth_token ?? hash ???????. |
