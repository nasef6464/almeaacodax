...
assertIncludes('server/src/routes/health.routes.ts', 'resolveRuntimeCommit');
assertIncludes('server/src/observability/releaseIdentity.ts', 'RENDER_GIT_COMMIT');
assertIncludes('server/src/observability/releaseIdentity.ts', 'VERCEL_GIT_COMMIT_SHA');
assertIncludes('server/src/observability/releaseIdentity.ts', 'GIT_COMMIT_SHA');
assertIncludes('server/src/observability/releaseIdentity.ts', 'COMMIT_SHA');
