...
assertIncludes('pages/Reports/studentAnalyticsViewModel.ts', 'isReliable: data.evidenceCount >= minSkillEvidence');
assertIncludes('pages/Reports/studentEvidenceWindowViewModel.ts', 'export const RECENT_STUDENT_QUIZ_RESULT_LIMIT = 5;');
...
assertIncludes('services/apiGroups/questionsApi.ts', 'ids?: string;');
...
assertIncludes('services/apiGroups/questionsApi.ts', 'summary?: boolean');
assertIncludes('services/apiGroups/questionsApi.ts', 'noTotal?: boolean');
...
assertIncludes('server/src/modules/quizzes/http/questionBankRoutes.ts', 'QUESTION_SUMMARY_CACHE_TTL_MS');
...
assertIncludes('services/apiGroups/taxonomyContentApi.ts', 'getPublicAnnouncementAds: () =>');
assertIncludes('server/src/modules/content/http/contentPresentationRoutes.ts', '"/announcement-ads"');
assertIncludes('server/src/modules/content/http/contentPresentationRoutes.ts', '.limit(8)');
