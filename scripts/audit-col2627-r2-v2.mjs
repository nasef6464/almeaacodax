...
const BASE_URL = String(process.env.R2_PUBLIC_BASE_URL || "https://pub-335cc83968b2426d915cacd8e6dc085d.r2.dev").replace(/\/$/, "");
const ITEMS = [
  {
...
const report = {
  ...
  auditScope: "reachability_only",
  visualIntegrityIssue: "#264",
  downloadedForEvidence: ITEMS.length,
  warning: "Reachability does not prove visual/source correctness. Follow issue #264 acceptance rules before linking any image.",
  rows,
};
