...
includesAll(workspace, ['buildSchoolDirectorAcademicWorkspace','buildSchoolDirectorClassOptions','createSchoolDirectorAssessment','createSchoolDirectorIntervention','transferSchoolDirectorStudent','Assessment questions must belong to one learning path','showOnPlatform: false','Use class move inside the same school'], 'G12 reuses existing academic engines and explicit transfer boundary');
